          ...
          <tbody>
            {orders.length > 0 ? orders.map((order) => (
              ...
              className='border-b hover:border-gray-50 cursor-pointer'>
                ...
                <td className='py-2 px-4 sm:py-4'>{order.createdAt.toLocaleDateString()}</td>
                <td className='py-2 px-4 sm:py-4'>{order.shippingAddress.city}, {order.shippingAddress.country}</td>
                ...
                <td className='py-2 px-4 sm:py-4'>
                  <span className={`${order.isPaid ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"} px-4 py-2 rounded-full text-xs sm:text-sm font-medium`}>
